                ...
                <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                    <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                            Order Details <i>({order.restaurantName})</i>
                        </h3>
                    ...
                    <div className="p-4 md:p-5 grid gap-4 mb-4 grid-cols-2">
                        <div className="col-span-2">
                            ...
                            <input disabled type="text" name="name" id="name" value={order.name} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                        </div>
                        <div className="col-span-2">
                        ...
                        <div className="col-span-1">
                            <label htmlFor="bill" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-left" >
                                Total Bill: 
                            </label>
                        </div>
                        <div className="col-span-1">
